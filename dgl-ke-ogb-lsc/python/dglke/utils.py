    ...
    def __init__(self):
        ...
        self.add_argument('--model_name', default='TransE',
                          choices=['TransE', 'TransE_l1', 'TransE_l2', 'TransR',
                                   'RESCAL', 'DistMult', 'ComplEx', 'ComplExPriori', 'RotatE',
                                   'SimplE', 'CP', 'AutoSF'],
        ...
        self.add_argument('--num_neg_chunk', type=int, default=10,
                          help='The number of negative chunks.')
        ...
        self.add_argument('--mlp_hidden_dim', type=int, default=3000,
                          help='The embedding size of MLP')

        self.add_argument('--feat_dim', type=int, default=200,
                          help='The embedding size of final dimension of RoBERTa features after MLP')
        ...
        self.add_argument('--loss_genre', default='Logsigmoid',
                          choices=['Hinge', 'Logistic', 'Logsigmoid', 'BCE', 'CE'],
